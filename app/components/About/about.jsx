    ...
    <div className=' bg-customDarkPurple justify-center items-center flex h-full w-full'>
      <div className='w-1200 flex justify-center items-center'>
        ...
        <div className='w-550 flex flex-col mr-6'>
          ...
          <div className=" bg-customCream mt-6 cursor-pointer hover:bg-customDarkPurple hover:text-customCream hover:border-customCream flex text-customDarkPurple w-fit p-3 rounded-xl border border-customCream items-center justify-center">
